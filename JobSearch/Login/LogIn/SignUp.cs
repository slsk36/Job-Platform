...
namespace Login
{
    public partial class SignUp : Form
    {
        ...
        private void check_com_textbox()
        {
            ...
            else if (String.IsNullOrEmpty(text_comNum.Text) || String.IsNullOrWhiteSpace(text_comNum.Text) || "10자리 숫자만 입력".Equals(text_comNum.Text) || (text_comNum.TextLength < 10))
        ...
        private void btn_idCheck_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                if(String.IsNullOrEmpty(text_id.Text) || String.IsNullOrWhiteSpace(text_id.Text))
                {
