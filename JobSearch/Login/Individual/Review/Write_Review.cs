            ...
            try
            {
                ...
                */
                cmd.CommandText = "insert into review (rev_num, w_num, rev_id, rev_comName,rev_place,rev_field, rev_subject, content, r_date, rev_star_pt) " +
                                                            "values(NEXT VALUE FOR RE_NUMBER,@w_num,@r_id,@r_comName,@r_place,@r_field,@r_subject,@content,@r_date,@r_star);";
                ...
                cmd.CommandText = $"select * from COM_INFO where COM_NAME = '{review_ComName}'";
                ...
                {
                    cmd.CommandText = $"update COM_INFO set STAR_PT = (select AVG(rev_star_pt) from review where rev_comName = '{review_ComName}') where COM_NAME = '{review_ComName}'";
